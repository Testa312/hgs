...
namespace GlacialComponents.Controls
{
	...
	public class GlacialList : System.Windows.Forms.Control
	{
		...
		{
			//this.Columns.
		//	if ( this.ControlStyle == GLControlStyles.XP )//2022.7.24
...
#endif
			if (this.IsDisposed) return;//2022.8.24
        ...
        protected override void OnMouseWheel(MouseEventArgs e)//2022.7.25
        {
            DW("MouseWheel");

            if (vPanelScrollBar.Visible && e.Delta != 0)
            {
                var smallChange = vPanelScrollBar.SmallChange *4;//2022.7.25 *4
