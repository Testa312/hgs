...
//			minSpaceT = Math.Max( minSpaceT, spaceT );
	...
	#region AddCurve Methods
		...
		{
            LineItem curve = new LineItem(label, x, y, color, SymbolType.Default, SymbolType.Default);
		...
		{
			LineItem curve = new LineItem( label, points, color, SymbolType.Default,SymbolType.Default );
			_curveList.Add( curve );
		...
		public LineItem AddCurve( string label, double[] x, double[] y,
            Color color, SymbolType symbolType, SymbolType flagType)
		{
            LineItem curve = new LineItem(label, x, y, color, symbolType, flagType);
			_curveList.Add( curve );
		...
		public LineItem AddCurve( string label, IPointList points,
            Color color, SymbolType symbolType, SymbolType flagType)
		{
            LineItem curve = new LineItem(label, points, color, symbolType, flagType);
			_curveList.Add( curve );
